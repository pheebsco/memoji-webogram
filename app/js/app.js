...
angular.module('myApp', [
  ...
  $routeProvider.when('/package', {templateUrl: templateUrl('package'), controller: 'PackageController'})
  $routeProvider.when('/tos', {templateUrl: templateUrl('tos'), controller: 'TOSController'})
